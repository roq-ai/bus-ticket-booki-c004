...
export function CustomerListPage(props: CustomerListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['customer_name.contains', 'customer_address.contains', 'customer_contact.contains'],
          ...params.filters,
        },
        'customer',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'customer_address', header: 'Customer Address', accessorKey: 'customer_address' },
    { id: 'customer_contact', header: 'Customer Contact', accessorKey: 'customer_contact' },
    { id: 'customer_age', header: 'customer_age', accessorKey: 'customer_age' },
