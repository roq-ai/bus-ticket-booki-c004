    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.customer_contact}
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'customer_age',
              isInvalid: !!formik.errors?.customer_age,
            }}
            name="customer_age"
            error={formik.errors?.customer_age}
            value={formik.values?.customer_age}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('customer_age', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
