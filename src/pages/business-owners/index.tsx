...
export function BusinessOwnerListPage(props: BusinessOwnerListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: [
            'owner_name.contains',
            'owner_address.contains',
            'owner_contact.contains',
  ...
  const columns: ColumnType[] = [
    { id: 'owner_name', header: 'Owner Name', accessorKey: 'owner_name' },
    { id: 'owner_address', header: 'Owner Address', accessorKey: 'owner_address' },
    { id: 'owner_contact', header: 'Owner Contact', accessorKey: 'owner_contact' },
