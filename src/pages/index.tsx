...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Bus Ticket Booking Application`}</title>

        <meta
          name="description"
          content="Experience the highest rated Bus Ticket Booking Application. Enjoy exclusive bus offers and get Rs.350 off on your first booking. Simplifying your travel one journey at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXN8ZW58MHx8fHwxNjk3NTM5MTYxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@juanencalada?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Juan Encalada`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the highest rated Bus Ticket Booking Application. Enjoy exclusive bus offers and get Rs.350 off on your first booking. Simplifying your travel one journey at a time.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Bus Operator" type="bus-operator" abilities={appConfig.ownerAbilities} />
